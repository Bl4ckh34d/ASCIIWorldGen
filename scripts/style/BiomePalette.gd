...
func color_for_biome(biome: int, is_beach: bool) -> Color:
	...
	match biome:
		...
		BiomeClassifier.Biome.BOREAL_FOREST, BiomeClassifier.Biome.CONIFER_FOREST:
		...
		BiomeClassifier.Biome.VOLCANIC_BADLANDS:
			return Color(0.32, 0.28, 0.24)
		BiomeClassifier.Biome.SCORCHED_FOREST:
			return Color(0.44, 0.36, 0.22)
